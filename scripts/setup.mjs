...
if (!canRun("codex")) fail([
  "Codex CLI is required for the live per-call proof and shadow runs.",
  "It provides the Responses request path the local proxy routes.",
...
run(npmCommand, ["test"]);
console.log("setup: ready. Start the proxy with npm start (JEV_ROUTER_OFF=1 bypasses routing).");
